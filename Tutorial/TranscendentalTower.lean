...
/-! Transcendental-tower chapter — the three monomials and the computable carriers
they build, backed by the real formalized types (rendered inline). -/
...
The decisive property is that this carrier is _itself_ a computable field. So the
