...
import DeepWiki.MeasureTheory.CompactSystem
import Mathlib.MeasureTheory.Measure.AddContent

/-! # Sigma-additivity of a regular additive content on a compact system
Vendored from `RemyDegenne/kolmogorov_extension4` (Apache 2.0), pending upstreaming
into Mathlib. -/
