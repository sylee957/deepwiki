...
/-! # Basic Gröbner-basis predicates

Core definitions for initial ideals, Gröbner bases, reduced Gröbner bases, and the
basic existence and remainder-membership criteria over a monomial order.
-/
