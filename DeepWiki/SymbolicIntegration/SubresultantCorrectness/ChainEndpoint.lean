...
theorem isSimilar_subresPRS_telescope (fuel : ℕ) (G : ℕ → BPoly)
    (bt : ℕ → DensePoly ℚ) (s : ℕ → BPoly) (c : ℕ → DensePoly ℚ) (j m : ℕ)
...
structure IsSubresPRSChainInput (fuel : ℕ) (G : ℕ → BPoly) (bt : ℕ → DensePoly ℚ)
    (s : ℕ → BPoly) (c : ℕ → DensePoly ℚ) (m : ℕ) : Prop where
...
theorem isSimilar_lrtSubresultant_subresPRS_elt (fuel : ℕ) (A D : DensePoly ℚ) (G : ℕ → BPoly)
    (bt : ℕ → DensePoly ℚ) (s : ℕ → BPoly) (c : ℕ → DensePoly ℚ) (m : ℕ)
