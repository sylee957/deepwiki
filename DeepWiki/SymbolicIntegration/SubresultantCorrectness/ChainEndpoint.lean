...
theorem isSimilar_subresPRS_telescope (fuel : ℕ) (G : ℕ → BPoly)
    (bt : ℕ → CPoly ℚ) (s : ℕ → BPoly) (c : ℕ → CPoly ℚ) (j m : ℕ)
...
structure IsSubresPRSChainInput (fuel : ℕ) (G : ℕ → BPoly) (bt : ℕ → CPoly ℚ)
    (s : ℕ → BPoly) (c : ℕ → CPoly ℚ) (m : ℕ) : Prop where
...
theorem isSimilar_lrtSubresultant_subresPRS_elt (fuel : ℕ) (A D : CPoly ℚ) (G : ℕ → BPoly)
    (bt : ℕ → CPoly ℚ) (s : ℕ → BPoly) (c : ℕ → CPoly ℚ) (m : ℕ)
