...
/-! # Rothstein-Trager residue linear factors

Abstract polynomial facts identifying residue-resultant roots and normalized
residue gcds with their linear factors.
-/
