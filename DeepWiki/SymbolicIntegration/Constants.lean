...
/-! # Constants and Wronskians

Basic API for constants in differential extensions, iterated derivatives, and the Wronskian
determinant used to detect dependence over constants. -/
