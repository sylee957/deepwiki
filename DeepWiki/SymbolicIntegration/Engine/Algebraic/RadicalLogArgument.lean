...
def radLogResidual (ρ : QFunNZ ℚ) (integrand : RadElem (QFunNZ ℚ)) (D : CPoly ℚ)
...
def radLogBasis (degBound : ℕ) : List (RadElem (QFunNZ ℚ)) :=
...
def radLogMatrix (ρ : QFunNZ ℚ) (integrand : RadElem (QFunNZ ℚ)) (D : CPoly ℚ)
...
def radLogArgSolve (ρ : QFunNZ ℚ) (integrand : RadElem (QFunNZ ℚ)) (D : CPoly ℚ)
