...
/-- The general-curve integral `∫ = v + Σ cᵢ log uᵢ`: rational part `ratPart : CPoly (QFunNZ ℚ)`
...
principal-generator oracle `genGen : ℕ → CPoly (QFunNZ ℚ)` giving, for order `m`, a `g` with
...
def genCurveTorsionLogTerm (fuel : ℕ) (f : CPoly (QFunNZ ℚ)) (basis : List (CPoly (QFunNZ ℚ)))
    (tin : GeneralCurveTorsionInputs) : Option (QFunNZ ℚ × CPoly (QFunNZ ℚ)) :=
...
def cIntegrateGeneralCurveDecide (fuel : ℕ) (f : CPoly (QFunNZ ℚ)) (basis : List (CPoly (QFunNZ ℚ)))
...
theorem genCurveTorsionLogTerm_none_of_decide_none (fuel : ℕ) (f : CPoly (QFunNZ ℚ))
    (basis : List (CPoly (QFunNZ ℚ))) (degBound : ℕ) (ratIntegrand logIntegrand : CPoly (QFunNZ ℚ))
    (tin : GeneralCurveTorsionInputs) (hasLogPart : Bool)
...
variable (fuel : ℕ) (f : CPoly (QFunNZ ℚ)) (basis : List (CPoly (QFunNZ ℚ))) (degBound : ℕ)
variable (ratIntegrand logIntegrand : CPoly (QFunNZ ℚ)) (tin : GeneralCurveTorsionInputs)
variable (hasLogPart : Bool) (integrand commonDenomQ : CPoly (QFunNZ ℚ))
variable (cofs : List (CPoly (QFunNZ ℚ)))
...
variable (fuel : ℕ) (f : CPoly (QFunNZ ℚ)) (basis : List (CPoly (QFunNZ ℚ)))
...
theorem cIntegrateGeneralCurveDecide_complete {isTorsion elem : Prop} (v : CPoly (QFunNZ ℚ))
    (hres : GeneralPicTorsionFrontier fuel f basis tin isTorsion elem)
...
theorem decide_isSome_iff_genTorsion_isSome (v : CPoly (QFunNZ ℚ))
    (hv : afRationalSolveWf f basis degBound ratIntegrand = some v)
...
theorem cIntegrateGeneralCurveDecide_decides {isTorsion elem : Prop} (v : CPoly (QFunNZ ℚ))
    (hres : GeneralPicTorsionFrontier fuel f basis tin isTorsion elem)
    (hv : afRationalSolveWf f basis degBound ratIntegrand = some v)
    (hlog : afLogArgSolveWf f basis degBound logIntegrand = none) :
...
def genCurveWitnessTorsion : Option GeneralCurveIntegralResult :=
  cIntegrateGeneralCurveDecide 8 gcuspCubicF gcuspCubicBasis 2
    ([] : CPoly (QFunNZ ℚ)) ([CField.one] : CPoly (QFunNZ ℚ)) genCurveWitnessTorsionInputs true
...
def genCurveWitnessNonTorsion : Option GeneralCurveIntegralResult :=
  cIntegrateGeneralCurveDecide 2 hcubeF hcubeBasis 2
    ([] : CPoly (QFunNZ ℚ)) ([CField.one] : CPoly (QFunNZ ℚ)) genCurveWitnessNonTorsionInputs true
...
example (fuel : ℕ) (f : CPoly (QFunNZ ℚ)) (basis : List (CPoly (QFunNZ ℚ))) (degBound : ℕ)
    (ratIntegrand logIntegrand : CPoly (QFunNZ ℚ)) (tin : GeneralCurveTorsionInputs)
    (hasLogPart : Bool) (integrand commonDenomQ : CPoly (QFunNZ ℚ)) (cofs : List (CPoly (QFunNZ ℚ)))
    (hres : GeneralCurveDecideSoundnessResidual fuel f basis degBound ratIntegrand logIntegrand tin
      integrand commonDenomQ cofs)
    (F : GeneralCurveIntegralResult)
    (hsome : cIntegrateGeneralCurveDecide fuel f basis degBound ratIntegrand logIntegrand tin hasLogPart
...
example (fuel : ℕ) (f : CPoly (QFunNZ ℚ)) (basis : List (CPoly (QFunNZ ℚ))) (degBound : ℕ)
    (ratIntegrand logIntegrand : CPoly (QFunNZ ℚ)) (tin : GeneralCurveTorsionInputs)
    {isTorsion elem : Prop} (v : CPoly (QFunNZ ℚ))
    (hres : GeneralPicTorsionFrontier fuel f basis tin isTorsion elem)
    (hv : afRationalSolveWf f basis degBound ratIntegrand = some v)
    (hlog : afLogArgSolveWf f basis degBound logIntegrand = none)
    (hnone : cIntegrateGeneralCurveDecide fuel f basis degBound ratIntegrand logIntegrand tin true
