...
def case3 : CPoly ℚ := cscale (1/2 : ℚ) (cderiv case3F)
...
def case3B : CPoly ℚ := radCase3Cofactor case3F case3 case3C

/-- The Case-3 residual `D = B'f + Bg − C` — expected `−x` (degree `1 < deg C = 2`). -/
def case3D : CPoly ℚ := radCase3Residual case3F case3 case3B case3C (cderiv case3B)
