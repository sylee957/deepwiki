      ...
      (cadd
        ...
        (cmul case2W
          (cadd (cmul (cderiv case2B) case2H)
            (cmul [CField.div CCommRing.one (CField.natCast 2)] (cmul case2B (cderiv case2H))))))
