...
theorem gd_integralBasis_nontrivial :
    (cisZero (csub (gcuspCubicBasis.getD 2 []) [CCommRing.zero, CCommRing.zero, CFrac.ofFraction [1] [0, 1] (by decide)])
...
theorem gen_divisor_representation_validates :
    ...
    (cisZero (csub (gcuspCubicBasis.getD 2 [])
        [CCommRing.zero, CCommRing.zero, CFrac.ofFraction [1] [0, 1] (by decide)]))
