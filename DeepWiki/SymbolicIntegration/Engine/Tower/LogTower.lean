...
/-- The common remainder-carrying stage contract for a tower antiderivative at one depth. -/
...
/-- Lift a stage whose output integrates to an input-selected remainder into the common remainder contract. -/
