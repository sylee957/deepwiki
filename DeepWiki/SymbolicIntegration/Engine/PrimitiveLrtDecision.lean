...
primitive case: `IsElementaryIntegrableGenuineLrtG Dt a d ↔ cResidueConstantGuard Dt a d = true`.
-/
...
theorem primitiveLrtDecides [LrtLiouvilleFrontier α] (Dt a d : CPoly α) (hd0 : toPoly d ≠ 0)
    (hsuff : cResidueConstantGuard Dt a d = true → IsElementaryIntegrableGenuineLrtG Dt a d) :
