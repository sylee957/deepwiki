...
theorem toPoly_hermiteInner_Vpow (V : CPoly ℚ) (j : ℕ) :
...
private def hbezPred (fuel : ℕ) (V U : CPoly ℚ) (j' : ℕ) (A' : CPoly ℚ) : Prop :=
...
structure IsHermiteInnerBezoutInput (fuel : ℕ) (V U : CPoly ℚ) : Prop where
...
theorem hermiteInner_spec_acc (fuel : ℕ) (V U : CPoly ℚ) (hU : toPoly U ≠ 0) (hV : toPoly V ≠ 0)
    (hbez : ∀ (j' : ℕ) (A' : CPoly ℚ), hbezPred fuel V U j' A') :
    ∀ (j : ℕ) (A : CPoly ℚ) (g : QFun), toPoly g.2 ≠ 0 →
...
theorem hermiteInner_spec (fuel : ℕ) (V U : CPoly ℚ) (hU : toPoly U ≠ 0) (hV : toPoly V ≠ 0)
    (hbez : ∀ (j' : ℕ) (A' : CPoly ℚ), hbezPred fuel V U j' A') (j : ℕ) (A : CPoly ℚ) :
    algebraMap ℚ[X] (RatFunc ℚ) (toPoly A)
        / (algebraMap ℚ[X] (RatFunc ℚ) (toPoly U)
            * algebraMap ℚ[X] (RatFunc ℚ) (toPoly V) ^ (j + 1))
...
theorem hermiteInner_bezout_of (fuel : ℕ) (V U : CPoly ℚ) (j' : ℕ) (A' : CPoly ℚ)
...
theorem hermiteInner_spec_of (fuel : ℕ) (V U : CPoly ℚ) (hU : toPoly U ≠ 0) (hV : toPoly V ≠ 0)
    (hbez : IsHermiteInnerBezoutInput fuel V U) (j : ℕ) (A : CPoly ℚ) :
    algebraMap ℚ[X] (RatFunc ℚ) (toPoly A)
        / (algebraMap ℚ[X] (RatFunc ℚ) (toPoly U)
            * algebraMap ℚ[X] (RatFunc ℚ) (toPoly V) ^ (j + 1))
      = (toQFun (hermiteInner fuel V U j A qzero).1)′
...
open scoped Differential in
example (fuel : ℕ) (V U : CPoly ℚ) (hU : toPoly U ≠ 0) (hV : toPoly V ≠ 0) (hq : cnorm V ≠ [])
    (hg : toPoly (cgcdExt fuel (cmul U (cderiv V)) V).1
      = Polynomial.C (clead (cgcdExt fuel (cmul U (cderiv V)) V).1))
    (hgc : clead (cgcdExt fuel (cmul U (cderiv V)) V).1 ≠ 0) (j : ℕ) (A : CPoly ℚ) :
    algebraMap ℚ[X] (RatFunc ℚ) (toPoly A)
        / (algebraMap ℚ[X] (RatFunc ℚ) (toPoly U)
            * algebraMap ℚ[X] (RatFunc ℚ) (toPoly V) ^ (j + 1))
      = (toQFun (hermiteInner fuel V U j A qzero).1)′
