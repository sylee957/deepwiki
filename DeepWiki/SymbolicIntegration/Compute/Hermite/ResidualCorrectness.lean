...
structure IsHermiteResidualInput (D gden Dstar : CPolyQ) : Prop where
...
theorem hermiteReduce_residual_correct (fuel : ℕ) (A D : CPolyQ)
    (gnum gden Dstar : CPolyQ)
...
theorem toQFun_cnorm (gnum gden : CPolyQ) :
...
theorem hermiteReduce_spec_cnorm (fuel : ℕ) (A D gnum gden Dstar : CPolyQ)
    (hden : IsHermiteResidualInput D gden Dstar)
    (hexact : toPoly (cmod fuel
        (cmul (csub (cmul A (cmul gden gden))
            (cmul D (csub (cmul (cderiv gnum) gden) (cmul gnum (cderiv gden))))) Dstar)
...
theorem hermiteReduce_residual_correct_of_dvd (fuel : ℕ) (A D gnum gden Dstar : CPolyQ)
    (hden : IsHermiteResidualInput D gden Dstar)
...
theorem hermiteReduce_residual_correct_of_split (fuel : ℕ) (A D gnum gden Dstar : CPolyQ)
    (hden : IsHermiteResidualInput D gden Dstar)
    (hfuel : (cnorm (cmul (csub (cmul A (cmul gden gden))
        (cmul D (csub (cmul (cderiv gnum) gden) (cmul gnum (cderiv gden))))) Dstar)).length ≤ fuel)
...
theorem hermiteReduce_residual_correct_of_radical (fuel : ℕ) (A D gnum gden Dstar : CPolyQ)
    (hden : IsHermiteResidualInput D gden Dstar)
    (hfuel : (cnorm (cmul (csub (cmul A (cmul gden gden))
        (cmul D (csub (cmul (cderiv gnum) gden) (cmul gnum (cderiv gden))))) Dstar)).length ≤ fuel)
...
def HermiteResComp (fuel : ℕ) (A D gnum gden Dstar : CPolyQ) : Prop :=
...
instance decHermiteResComp (fuel : ℕ) (A D gnum gden Dstar : CPolyQ) :
...
theorem hermiteReduce_residual_correct_uncond (fuel : ℕ) (A D gnum gden Dstar : CPolyQ)
    (hden : IsHermiteResidualInput D gden Dstar)
    (hfuel : (cnorm (cmul (csub (cmul A (cmul gden gden))
        (cmul D (csub (cmul (cderiv gnum) gden) (cmul gnum (cderiv gden))))) Dstar)).length ≤ fuel)
...
open scoped Differential in
example (fuel : ℕ) (A D gnum gden Dstar : CPolyQ)
