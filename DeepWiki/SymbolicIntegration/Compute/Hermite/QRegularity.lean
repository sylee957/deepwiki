...
theorem glocIncr_toQFun_isQRegular (fuel : ℕ) (A D : DensePoly ℚ) (Vi : DensePoly ℚ × ℕ) {Q : ℚ[X]}
...
theorem deriv_fold_sub_glocIncr_isQRegular (fuel : ℕ) (A D : DensePoly ℚ)
    (factors : List (DensePoly ℚ × ℕ)) (kelem : DensePoly ℚ × ℕ)
