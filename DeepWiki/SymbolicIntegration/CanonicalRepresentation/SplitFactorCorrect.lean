...
/-! # Correctness of canonical split factors

Correctness theorems for the `splitFactorStep`, `splitFactorAux`, and `splitFactor`
denominator split used by canonical representations.
-/
