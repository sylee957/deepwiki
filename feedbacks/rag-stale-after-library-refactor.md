...
- **Additional occurrence:** On 2026-07-23, `search "transcendental derivation rational
  function differential extension"` returned `unique_derivation_rationalFunction` under the
  retired `Core/Differential/DerivationExt.lean` path after that declaration had moved to
  `DifferentialAlgebra/DerivationExtension.lean`.
