...
open DeepWiki.SymbolicIntegration.DensePoly DeepWiki.SymbolicIntegration.LogResidue
...
abbrev sound_afDeriv_keystone := @DensePoly.mk_toPolyG_afDerivWf
...
abbrev sound_genRationalPredicate := @DensePoly.IsGeneralRationalIntegralWf
...
abbrev sound_genGen := @DensePoly.mk_toPolyG_afDerivWf_genGen
...
abbrev sound_genRationalTelescope := @DensePoly.generalReduceRationalTelescopeWf
...
abbrev sound_genLogPredicate := @DensePoly.IsGeneralLogTermWf
...
abbrev sound_genLogSoundness := @DensePoly.isGeneralLogIntegralWf_of_residue_match
...
`IsAlgebraicIntegral`. -/
abbrev sound_genCapstonePredicate := @DensePoly.IsGeneralAlgebraicIntegralWf
...
abbrev sound_genCapstone := @DensePoly.isGeneralAlgebraicIntegralWf_of_parts
