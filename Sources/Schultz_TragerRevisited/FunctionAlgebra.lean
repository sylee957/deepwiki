...
`CPolyG.afIntegrateFunctionAlgebra`. -/
abbrev afIntegrateFunctionAlgebra := @CPolyG.afIntegrateFunctionAlgebra
...
`CPolyG.afIntegrateFunctionAlgebra_sound`. -/
abbrev afIntegrateFunctionAlgebra_sound := @CPolyG.afIntegrateFunctionAlgebra_sound
