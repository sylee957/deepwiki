...
/-- **`A = 8x⁹+x⁸−12x⁷−4x⁶−26x⁵−6x⁴+30x³+23x²−2x−7`** as a `CPoly ℚ` (Exercise 2.2 numerator),
coefficients low→high. -/
def cA22 : CPoly ℚ := [-7, -2, 23, 30, -6, -26, -4, -12, 1, 8]

/-- **`D = x¹⁰−2x⁸−2x⁷−4x⁶+7x⁴+10x³+3x²−4x−2`** as a `CPoly ℚ` (Exercise 2.2 denominator),
coefficients low→high. -/
def cD22 : CPoly ℚ := [-2, -4, 3, 10, 7, 0, -4, -2, 0, -2, 1]
...
/-- **The Rothstein–Trager resultant `R(t) = res_x(D, A − t·D')`** of Exercise 2.2 as a `CPoly ℚ`
