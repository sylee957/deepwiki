...
/-- **Theorem 6.7** (§6.1), union case: C-tables correctly evaluate union — the instance of the
union is the union of the instances. -/
abbrev thm_6_7_union := @DeepWiki.CTable.instAt_union

/-- **Theorem 6.7** (§6.1), projection case: C-tables correctly evaluate projection. -/
abbrev thm_6_7_projection := @DeepWiki.CTable.instAt_proj
