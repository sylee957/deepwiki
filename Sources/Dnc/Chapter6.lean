...
/-- **Proposition 6.8** (§6.2.2, p.139): If w ≥ (β ⊘ β²)(0), then β_wfc ≥ β (and hence β_wfc = β, since the closure vanishes at the origin). -/
alias prop_6_8 := DeepWiki.window_mem_feedbackControlSet_self
