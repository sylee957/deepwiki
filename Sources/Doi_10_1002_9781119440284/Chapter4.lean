...
(`thm_4_2_merge_pwl`), into a single arbitrary-slope `Pwl` segment list — closing Theorem 4.2's output
as one explicit curve, end to end. The library's `DeepWiki.minConv_concaveNFEval_eq_mergeAll`. -/
